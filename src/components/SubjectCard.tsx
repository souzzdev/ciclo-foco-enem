...
export function SubjectCard({ subject, onToggleHour, style }: SubjectCardProps) {
  ...
  const handleToggle = useCallback((index: number) => {
    ...
    onToggleHour(subject.id, index);
  }, [subject.id, subject.completedHours, onToggleHour]);

  return (
    <div
      className="bg-card rounded-2xl p-4 shadow-sm transition-all duration-300 hover:shadow-md card-stagger"
      style={style}
    >
      {/* Header */}
